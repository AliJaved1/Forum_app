...
insert into post values('158', '17', 5001, 2500, 'Ronaldo Leaves Real Madrid!');
insert into post values('9932', '3350', 10, 5345, 'Dr. Recommends an apple a day.');
insert into post values('8168', '351', 947, 5, 'Elden Ring most played game of 2022');
insert into post values('554', '41', 8811, 23, 'Why dont we have any moderators on this site!?!?');
insert into post values('9002', '873', 1000, 9923, 'Unpopular Opinion: water sucks');

insert into usercomment values('31', '158', '3350', 31, 5, 'wow thats really insightful!');
insert into usercomment values('33324', '9932', '351', 40, 10, 'youre just wrong here, how can you say that!?');
insert into usercomment values('8217', '8168', '41', 35, 100, 'ill have you know I graduated at the top of my class');
insert into usercomment values('132', '554', '873', 4512, 23, 'actually if you use this weapon you can get 100 more damage');
insert into usercomment values('53452', '9002', '17', 9529, 501, 'the site has come a long way now!');
